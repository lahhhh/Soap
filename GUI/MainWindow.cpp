...
void MainWindow::s_save_pdf_and_png() {
	...
	std::string pdfFileName = pdf_name.toStdString();
	const char* input = pdfFileName.c_str();
	std::string picFileName = picture_name.toStdString();
	const char* output = picFileName.c_str();
