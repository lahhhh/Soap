...
void DenseDoubleItem::update_shape() {

    this->setText(2, "[ " + QString::number(this->data()->mat_.rows()) + " | " + QString::number(this->data()->mat_.cols()) + " ]");
};


void DenseDoubleItem::s_search_row() {
...
void DenseDoubleItem::s_search_column() {
...
void DenseDoubleItem::s_search_block() {
...
void DenseDoubleItem::s_correlation_plot() {
    ...
    Eigen::ArrayXd f1 = this->data()->mat_.row(index_1);
