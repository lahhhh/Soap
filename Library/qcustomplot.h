...
public:
	...
	*/
	...
	// introduced virtual methods:
	virtual void generate(const QCPRange& range, const QLocale& locale, QChar formatChar, int precision, QVector<double>& ticks, QVector<double>* subTicks, QStringList* tickLabels);
...
protected:
	...
	virtual QStringList createLabelVector(const QVector<double>& ticks, const QLocale& locale, QChar formatChar, int precision);
...
public:
	...
	void setTicks(const QVector<double>& positions, const QStringList& labels);
	...
	void addTicks(const QVector<double>& positions, const QStringList& labels);
...
class QCP_LIB_DECL QCPAxis : public QCPLayerable
{
	Q_OBJECT
		...
		Q_PROPERTY(QStringList tickVectorLabels READ tickVectorLabels)
...
public:
	...
	*/
	...
	QStringList tickVectorLabels() const { return mTickVectorLabels; }
